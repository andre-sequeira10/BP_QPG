...
for np_name in glob.glob('cartpole_n_1_inpt_scaling-0_n_layers-3*_grads_norm*'):
    grad_norm_local.append(np.load(np_name))
for np_name in glob.glob('cartpole_n_1_inpt_scaling-0_n_layers-3*grads_var*'):
    var_local.append(np.load(np_name))
for np_name in glob.glob('cartpole_n_1_inpt_scaling-0_n_layers-3||*'):
    reward_cumul_local.append(np.load(np_name))

for np_name in glob.glob('cartpole_n2_1_inpt_scaling-0_n_layers-3*_grads_norm*'):
    grad_norm_local_input_scaling.append(np.load(np_name))
for np_name in glob.glob('cartpole_n2_1_inpt_scaling-0_n_layers-3*grads_var*'):
    var_local_input_scaling.append(np.load(np_name))
for np_name in glob.glob('cartpole_n2_1_inpt_scaling-0_n_layers-3||*'):
    reward_cumul_local_input_scaling.append(np.load(np_name))

for np_name in glob.glob('cartpole_n3_1_inpt_scaling-0_n_layers-3*_grads_norm*'):
    grad_norm_global_input_scaling.append(np.load(np_name))
for np_name in glob.glob('cartpole_n3_1_inpt_scaling-0_n_layers-3*grads_var*'):
    var_global_input_scaling.append(np.load(np_name))
for np_name in glob.glob('cartpole_n3_1_inpt_scaling-0_n_layers-3||*'):
...
axs[0].plot(x_norm_var, smoothed_grad_norm_local[:len(x_norm_var)], label="local 1 qubit", color="purple", alpha=0.7)
...
axs[0].plot(x_norm_var, smoothed_grad_norm_local_input_scaling[:len(x_norm_var)], label="local 2 qubits", color="darkorange", alpha=0.7)
...
axs[0].plot(x_norm_var, smoothed_grad_norm_global_input_scaling[:len(x_norm_var)], label="local 3 qubits", color="darkgreen", alpha=0.7)
...
axs[1].plot(x_norm_var, smoothed_var_local[:len(x_norm_var)], label="local 1 qubit", color="purple", alpha=0.7)
...
axs[1].plot(x_norm_var, smoothed_var_local_input_scaling[:len(x_norm_var)], label="local 2 qubits", color="darkorange", alpha=0.7)
...
axs[1].plot(x_norm_var, smoothed_var_global_input_scaling[:len(x_norm_var)], label="local 3 qubits", color="darkgreen", alpha=0.7)
...
axs[2].plot(x_reward, smoothed_reward_cumul_local[:len(x_reward)], label="local 1 qubit", color="purple", alpha=0.7)
...
axs[2].plot(x_reward, smoothed_reward_cumul_local_input_scaling[:len(x_reward)], label="local 2 qubits", color="darkorange", alpha=0.7)
...
axs[2].plot(x_reward, smoothed_reward_cumul_global_input_scaling[:len(x_reward)], label="local 3 qubits", color="darkgreen", alpha=0.7)
